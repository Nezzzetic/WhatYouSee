 ...
 * Угол левый, а не правый, — там уже лента-закладка (K-05); левый нижний
 * занят только невидимой зоной тройного тапа дев-панели (`#devToggleBtn`,
 * 44×44 от самого края), поэтому пометка сдвинута правее неё на
 * `UNDO_MARK_CORNER_LEFT_PX`, а не встык с краем.
 */
