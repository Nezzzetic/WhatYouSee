...
en: {
    ...
    // строка, а не две мелких, — иначе таймер ниже перетягивал всё внимание
    // на себя, и сам факт конца ночи терялся (правка по живому фидбеку).
    'book.dawnLine': 'The night is done — new sky in',
...
ru: {
    ...
    // O-03: одна строка, а не две мелких — таймер ниже перетягивал внимание,
    // и сам факт конца ночи терялся (правка по живому фидбеку).
    'book.dawnLine': 'Ночь закончена — небо обновится через',
