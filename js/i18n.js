...
en: {
    ...
    // строка без секунд — «ночь закончена» снято отдельной правкой заказчика,
    // осталось только само ожидание нового неба.
...
ru: {
    ...
    // O-03: одна строка без секунд — «ночь закончена» снято отдельной
    // правкой заказчика, осталось только само ожидание нового неба.
