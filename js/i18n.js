...
en: {
    ...
    'shape.fan': 'Shuriken',
    'shape.radish': 'Rocket',
    'shape.donut': 'Soccer Ball',
    'shape.flag': 'Finish',
    'shape.tadpole': 'Music Note',
    'shape.bunny': 'Router',
    'shape.bull': 'Cat',
    'shape.bow': 'Superhero',
    'shape.house': 'Crypt',
    'shape.mace': 'Torch',
    'shape.kite': 'Mouse',
    'shape.lantern': 'Balloon',
    'shape.hand-fan': 'Mermaid',
    'shape.lollipop': 'Magnifier',
    'shape.book': 'Spellbook',
    'shape.origami': 'Fortune Teller',
    'shape.wheel': 'Ferris Wheel',
    'shape.hammock': 'Cobweb',
    'shape.perfectionist': 'Group Chat',
...
ru: {
    ...
    'shape.bunny': 'Роутер',
    'shape.bull': 'Кот',
    'shape.bow': 'Супергерой',
    'shape.house': 'Склеп',
    'shape.mace': 'Факел',
    'shape.kite': 'Мышка',
    'shape.lantern': 'Аэростат',
    'shape.hand-fan': 'Русалка',
    'shape.lollipop': 'Лупа',
    'shape.book': 'Книга заклинаний',
    'shape.origami': 'Гадалка',
    'shape.wheel': 'Колесо обозрения',
    'shape.hammock': 'Паутина',
    'shape.perfectionist': 'Групповой чат',
    ...
    'book.newsShapeOpened': 'Фигура «{name}» прочерчена впервые.',
