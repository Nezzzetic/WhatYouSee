...
en: {
    ...
    'shape.victory': 'Victory',
    'shape.caterpillar': 'Caterpillar',
    'shape.square': 'Square',
    'shape.rhombus': 'Rhombus',
    'shape.deltoid': 'Deltoid',
    'shape.quadrilateral': 'Quadrilateral',
    'shape.chain-4': 'Chain of 4',
    'shape.fork': 'Fork',
    'shape.zigzag': 'Zigzag',
    'shape.hourglass': 'Hourglass',
    'shape.pentagon': 'Pentagon',
    'shape.pentagon-irregular': 'Irregular Pentagon',
    'shape.star': 'Star',
    'shape.chain-5': 'Chain of 5',
    'shape.tree': 'Tree',
    'shape.mustache': 'Mustache',
    'shape.briefs': 'Briefs',
    'shape.iron': 'Iron',
    'shape.rubber-duck': 'Rubber Duck',
    'shape.unicorn': 'Unicorn',
    'shape.hook': 'Hook',
    'shape.mouse-cursor': 'Mouse Cursor',
    'shape.heart': 'Heart',
    'shape.ice-cream': 'Ice Cream',
    'shape.pizza-slice': 'Pizza Slice',
    'shape.glasses': 'Glasses',
    'shape.sock': 'Sock',
    'shape.butterfly': 'Butterfly',
    'shape.sausage': 'Sausage',
    'shape.jellyfish': 'Jellyfish',
...
ru: {
    ...
    'shape.victory': 'Победа',
    'shape.caterpillar': 'Гусеница',
    'shape.square': 'Квадрат',
    'shape.rhombus': 'Ромб',
    'shape.deltoid': 'Кайт',
    'shape.quadrilateral': 'Четырёхугольник',
    'shape.chain-4': 'Цепочка-4',
    'shape.fork': 'Вилка',
    'shape.zigzag': 'Зигзаг',
    'shape.hourglass': 'Песочные часы',
    'shape.pentagon': 'Пентагон',
    'shape.pentagon-irregular': 'Пятиугольник',
    'shape.star': 'Звезда',
    'shape.chain-5': 'Цепочка-5',
    'shape.tree': 'Дерево',
    'shape.mustache': 'Усы',
    'shape.briefs': 'Трусы',
    'shape.iron': 'Утюг',
    'shape.rubber-duck': 'Резиновая уточка',
    'shape.unicorn': 'Единорог',
    'shape.hook': 'Крюк',
    'shape.mouse-cursor': 'Курсор мыши',
    'shape.heart': 'Сердечко',
    'shape.ice-cream': 'Мороженное',
    'shape.pizza-slice': 'Кусок пиццы',
    'shape.glasses': 'Очки',
    'shape.sock': 'Носок',
    'shape.butterfly': 'Бабочка',
    'shape.sausage': 'Сосиска',
    'shape.jellyfish': 'Медуза',
