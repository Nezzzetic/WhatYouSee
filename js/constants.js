...
const SHAPE_PATTERNS = {
    ...
    // C-08: остриё повёрнуто вбок (было — треугольник над рукоятью, остриём вверх);
    // паттерн повёрнут на 90° вокруг центра, углы (валидатор §4) не меняются.
    'spatula': {
        stars: [[0.8, 0.35], [0.8, 0.65], [0.55, 0.5], [0.15, 0.5]],
...
const CATALOG_29 = {
    ...
    'spatula': { stars: [[0.8, 0.35], [0.8, 0.65], [0.55, 0.5], [0.15, 0.5]], lines: [[0, 1], [1, 2], [2, 0], [2, 3]], c: { cycleAngleMin: 25, outwardTail: true } },
