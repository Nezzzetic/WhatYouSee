...
// O-03: блок «конец ночи» показывает только минуты — секундная точность тика
// ему не нужна, поэтому и период реже, чем был бы у секундного счётчика.
const BOOK_DAWN_TICK_MS = 15000;
