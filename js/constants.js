...
// для этого случая — не по умолчанию для остального UI.
...
// Левый нижний угол занят невидимой зоной тройного тапа дев-панели
// (#devToggleBtn, 44×44 от самого края) — пометка сдвинута правее неё.
const UNDO_MARK_CORNER_LEFT_PX = 80;       // отступ от левого края экрана
const UNDO_MARK_CORNER_BOTTOM_PX = 22;     // отступ от низа (сверх инсета — getBottomUIHeight())
