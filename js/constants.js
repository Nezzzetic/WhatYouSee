...
const LEVEL_FINALE_HIDE_MS = 250;        // затемнение в начале: линии уходят в ноль
...
const LEVEL_FINALE_STEP_MS = 90;         // задержка между соседними созвездиями
const LEVEL_FINALE_FADE_MS = 420;        // проявление одного созвездия
const LEVEL_FINALE_TOTAL_MAX_MS = 2800;  // потолок ВСЕЙ сцены — шаг ужимается под него
const LEVEL_FINALE_STAR_FLASH_MS = 220;  // вспышка звезды в момент рождения её созвездия
