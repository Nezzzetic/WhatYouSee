...
// B-01: награда за ПЕРВОЕ создание каждой фигуры каталога — ровно один раз
// на фигуру, начисляется в markShapeCreated (progression.js). До B-01 константа
// была объявлена, но нигде не использовалась; после U-09 первое создание вообще
// перестало платить (пер-фигурные цепочки удалены), а это самое яркое событие
// игры — сюрприз-имя на коммите. 35 ✦ × 29 фигур = 1015 ✦, ~10 % дохода
// референсного игрока за 3 месяца.
const UNIQUE_DISCOVERY_BONUS = 35;
