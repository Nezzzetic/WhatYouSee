...
//
// ВРЕМЕННО 10, а не 5: договорный час — пять утра, но проверить механизм на
// устройстве в пять утра некому. Заказчик смотрит переворот суток в 10:00 и
// после этого час возвращается к 5 — задача не закрывается, пока стоит 10.
const SKY_DAY_START_HOUR = 10;
