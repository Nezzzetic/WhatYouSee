...
// Вплывание и уплывание: включённый тумблер не должен бить с середины такта,
// выключенный — обрываться на полуслове. Заметно длиннее сцены книги (700 мс)
// намеренно — это фон, а не отклик на жест.
